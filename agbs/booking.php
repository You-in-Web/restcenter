...
if(!$_POST['client_phone0'] || $_POST['client_phone0'] == '+' || !$_POST['client_phone1']){
$ERROR["client_phone0"]["text"] = "Укажите контактный телефон (Не заполнены поля).";
...
} else { if((strlen($client_phone2)<2) || (!preg_match("/^[0-9 ()-]{1,3}$/u", $_POST['client_phone2']))){
...
<input type="radio" name="oferta" required>Я ознакомлен с условиями договора<!--Текст возле чекбокса-->
