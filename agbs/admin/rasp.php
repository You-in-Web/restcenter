...
echo "<div class=\"filtr\" style=\"width:800px;\"><a href=\"back.php\"><span>&#9668;</span> В список заказов</a>";

if (empty($_GET)) {echo  "<b>Текущий месяц</b>";}
 
else if ($_GET["month"] !== date('n') && $_GET["year"] == date('Y')) {			
echo "<a href=\"rasp.php\">В текущий месяц</a>";

} else if ($_GET["year"] !== date('Y')) { echo "<a href=\"rasp.php\">В текущий месяц</a>"; }
else {	
echo  "<b>текущий месяц</b>";}
...
<a href=\"../booking_shed.php?day=".$week[$i][$j]."&month=".$month."&year=".$year."&weekday=".$j."\" title=\"Зарезервировать\" >".$week[$i][$j]."</a>

<ul class=\"booking_info\">
<li class=\"arrow_bi\"><span class=\"arrow_block\"></span></li>"; break 3;} 

}}}}
//--------------вывод информации о заказах на даты (прошедшие дни)
$file_name_lt = "../data/booking.dat"; 
//define('FILENAME', $file_name_lt);
$file_lt = fopen($file_name_lt,"r") ; 
flock($file_lt,LOCK_SH) ; 
...
<li>Заказчик: <b>$b_name</b></li>
<li>$b_phone</li>
<li>$b_mail</li>
<li>Комментарий: <br /><i>$b_comment</i></li>
<li>Добвавлено: $add_date</li>";
}
...
<td>
<div class=\"weekn_l".$class_d."\" style=\"position:relative;\">".$weekday_n[$j]."</div>
</td>"; }
...
<tr>
<td>
<div class=\"day_l".$class_d."\" style=\"position:relative;\">".$week[$i][$j]."</div>
</td>
...
$rasp .= "<a href=\"../booking_shed.php?day=".$week[$i][$j]."&month=".$month."&year=".$year."&weekday=".$j."\" title=\"Зарезервировать\" >".$week[$i][$j]."</a>";
...
//--------------подцветка завронированных дат в часовй зоне
$file_name_lt = "../data/booking.dat"; 
//define('FILENAME', $file_name_lt);
$file_lt = fopen($file_name_lt,"r") ; 
flock($file_lt,LOCK_SH) ; 
